    ...
    <section class="container marketing"> <!-- Container -->

      <!-- Three columns of text below the carousel -->
      <div class="row"> <!-- MARKETING -->

        <section class="col-lg-4 mark-box"> <!-- marketing1.jpg -->
          <img class="img-circle" src="img/marketing1.jpg" alt="Generic placeholder image" style="width: 140px; height: 140px;">
          <h2>Shabu</h2>
          <!--<p> For Shabu Shabu, we have a choice of Beef (Certified Angus Beef), Kurobuta (Pork imported from Japan), and Chicken Breast.  Our Spicy Miso Soup is one of the crowd favorite for Shabu Shabu. A must try!</p> -->
		  ...
		  <p><a class="btn btn-default" href="<? echo $_SERVER["PHP_SELF"];?>?l=menu" role="button">View menu &raquo;</a></p>
        </section><!-- End of marketing1 -->

        <section class="col-lg-4 mark-box"> <!-- marketing2.jpg -->
          ...
          <!-- <p>Rock Shrimp Roll is so far the best seller from our menu.  Rock Shrimp Roll is a Spicy Tuna Roll topped with eight big pieces of tempura rock shrimps, and the shrimp is tossed together with our creamy spicy mayo.</p> -->
          <p><a class="btn btn-default" href="<? echo $_SERVER["PHP_SELF"];?>?l=menu" role="button">View menu &raquo;</a></p>
        </section><!-- End of marketing2 -->

        <section class="col-lg-4 mark-box"> <!-- marketing3.jpg -->
