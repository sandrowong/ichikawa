    <section class="wrap container"> <!-- Container -->
      ...
      <section class="bg-about"><!-- <img src="img/ichikawa.jpg" class="img-responsive"> --></section>
        <p class="lead">Ichikawa Restaurant is a cozy restaurant with the objective to provide our customer “Great Food, Great Service, and Great Atmospheres!” </p>
